...
Across 7 zero-shot benchmarks, **LangFlow beats the autoregressive baseline on 2 out of 7 (PTB, Lambada) and MDLM on 3 out of 7 (PTB, Wikitext, Lambada)**. Overally, LangFlow performs better in zero-shot transfer compared to existing continuous and uniform diffusion methods.
