...
Hence, we parameterize $$H_\gamma$$-$$\gamma$$ by $$H'_\gamma \sim \mathrm{Gumbel}(\gamma; P_\mu, P_\beta)$$. In our experiments, we set $$P_\mu$$, $$P_\beta$$, and $$H(+\infty)$$ as trainable parameters.
