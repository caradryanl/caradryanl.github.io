...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-10 text-center">
        {% include figure.liquid loading="eager" path="assets/img/langflow/dilemma.png" class="img-fluid rounded z-depth-1" zoomable=true caption="Masked diffusion may mix up different target modes in few-step generation."%}
    </div>
</div>
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-10 text-center">
        {% include figure.liquid 
            ...
            zoomable=true
            caption="Discrete diffusion predicts logits from noisy discrete tokens. Our continuous diffusion predicts clean logits from noisy word embeddings, thus able to share the same network architecture with discrete diffusion."
        %}
    </div>
</div>
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-10 text-center">
        {% include figure.liquid loading="eager" path="assets/img/langflow/proposal.png" class="img-fluid rounded z-depth-1" zoomable=true caption="The dynamic of Gumbel parameters during training."%}
    </div>
</div>
