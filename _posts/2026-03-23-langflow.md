...
The impact is dramatic: ablations show the Gumbel proposal alone reduces Gen. PPL (↓) of LangFlow by a factor of **7×** (from ~1000 to ~150). This design choice is the key milestone that finally allows continuous diffusion to match its sample quality of that of discrete diffusion.
